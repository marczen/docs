---
title: "Co-Create, Discover, and Control — July 2025 Update"
...
<CardGroup cols={2}>
  <Card title="No Hard Caps (for now)" icon="infinity">
...
## 7) ✨  Quality-of-Life Mega-Bundle

* **Edit / Delete Comments** right on the Character Card.  
* **Smarter Recommendations** surface hidden gems quicker.  
* **Presence Indicators**—“…is chatting” / “50 users online”—make the place feel alive.  
* **Tutorial Refresh** to get newcomers building (and chatting) faster.
