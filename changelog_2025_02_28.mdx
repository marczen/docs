...
description: 'We’ve revamped our entire UI and added tons of improvements across the board. Here are some highlights!'
---

## Introduction

We’ve completely overhauled our user interface, making it sleeker, faster, and more intuitive than ever. Below, you'll find some of the key updates we’re most excited about—along with plenty of other tweaks and fixes under the hood.
...
<AccordionGroup>
  ...
  <Accordion icon="user-friends" title="Profiles & Follows">
...
<Note>
  For any questions or issues, email us at [support@mefriend.ai](mailto:support@mefriend.ai).  
  **Happy chatting!**  
