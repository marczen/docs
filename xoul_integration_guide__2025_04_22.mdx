...
From xoul after unzipping, you should see these folders:
...
![Import menu](/images/import_xoul/menu.png)

---

## 3) Drag & Drop Your Files

![Dropzone Screenshot](/images/import_xoul/dropzone.png)
...
- **Personas / Xouls** → visit **My Characters**. Imported items visibility default to the settings of Xoul, so no worries!
